<template>
  ...
  >
    ...
    <div class="p-3">
      ...
      <!-- My Tools Section -->
      <div class="mb-2">
        <div v-show="!uiStore.sidebarCollapsed" class="px-2 text-xs font-medium text-gray-500 dark:text-gray-500 mb-2">My Tools</div>
      ...
      <!-- Chats Section -->
      <div class="mt-4">
        <div v-show="!uiStore.sidebarCollapsed" class="px-2 text-xs font-medium text-gray-500 dark:text-gray-500 mb-2">Chats</div>
        <div class="space-y-0.5">
           <div v-if="conversationStore.conversations.length === 0 && !uiStore.sidebarCollapsed" class="px-3 py-2 text-sm text-gray-500 dark:text-gray-500">
            No Chat History
          </div>
          <div
          ...
          >
            <svg class="w-4 h-4 flex-shrink-0 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-auto p-3 border-t border-gray-200 dark:border-[#1a1a1a] space-y-1">
      ...
      >
       ...
       <div class="pt-2 mt-2 border-t border-gray-200 dark:border-[#1a1a1a] flex flex-col gap-1">
          <button class="flex items-center gap-3 px-3 py-2 text-sm text-indigo-600 dark:text-blue-400 hover:bg-gray-100 dark:hover:bg-[#1a1a1a] rounded-lg transition-colors text-left w-full">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" /></svg>
            <span v-show="!uiStore.sidebarCollapsed">Login</span>
          </button>
           <button class="flex items-center gap-3 px-3 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#1a1a1a] hover:text-gray-900 dark:hover:text-white rounded-lg transition-colors text-left w-full">
