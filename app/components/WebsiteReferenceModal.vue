      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          <TransitionChild as="template" enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel
              class="w-full max-w-[480px] transform overflow-hidden rounded-[24px] bg-[var(--background-white-main)] p-8 text-center align-middle shadow-[0px_20px_50px_rgba(0,0,0,0.1)] border border-[var(--border-main)] transition-all relative">
              <!-- Close Button -->
              <button @click="uiStore.closeWebsiteReferenceModal"
              ...
              <div class="flex justify-center mb-6">
                <div
                  class="w-16 h-16 rounded-[16px] border border-[var(--border-main)] bg-[var(--background-gray-main)] flex items-center justify-center">
                  <div class="relative w-8 h-8">
                    <!-- Simple document icon -->
                    <svg viewBox="0 0 24 24" fill="none" class="w-full h-full text-[var(--text-secondary)]"
                    ...
                    <div class="absolute -bottom-1 -right-1 bg-[var(--background-gray-main)] rounded-sm p-0.5">
                      <svg viewBox="0 0 24 24" fill="currentColor" class="w-3.5 h-3.5 text-[var(--text-primary)]">
                        <path
                          d="M14.017 21L14.017 18C14.017 16.8954 14.9124 16 16.017 16H19.017C20.1216 16 21.017 16.8954 21.017 18V21C21.017 22.1046 20.1216 23 19.017 23H16.017C14.9124 23 14.017 22.1046 14.017 21ZM14.017 21V18" />
                        <path
                          d="M3 21L3 18C3 16.8954 3.89543 16 5 16H8C9.10457 16 10 16.8954 10 18V21C10 22.1046 9.10457 23 8 23H5C3.89543 23 3 22.1046 3 21Z" />
                        <path d="M4.5 9.5C4.5 6.46243 6.96243 4 10 4M4.5 9.5C4.5 12.5376 6.96243 15 10 15M4.5 9.5H7.5"
                          stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
                          fill="none" />
                        <!-- Custom quote marks -->
              ...
              <div class="mb-4">
                <input type="text" v-model="websiteUrl"
                  ...
                  placeholder="https://www.example.com" @keyup.enter="handleAdd" />
              </div>

              <!-- Add Button -->
              <button @click="handleAdd" :disabled="!isValidUrl || isLoading"
              ...
              <!-- Footer Info -->
              <div
                class="bg-[var(--background-gray-main)] rounded-[16px] p-4 text-left border border-[var(--border-main)] flex gap-3">
                <Info :size="20" class="text-[var(--text-tertiary)] flex-shrink-0 mt-0.5" />
                <p class="text-[12px] text-[var(--text-secondary)] leading-[18px]">
                  Referenced content is for personal use and inspiration only. Ensure you have the right to use any
                  designs or content you recreate.
                </p>
              </div>
            </DialogPanel>
          </TransitionChild>
