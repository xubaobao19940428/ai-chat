<template>
  <div class="flex flex-col h-full bg-[#f8f9fa] dark:bg-[#050505] relative">
    ...
    <div class="flex-shrink-0 w-full z-10 pt-12 sm:pt-20 px-4">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="max-w-3xl mx-auto mb-12">
            <div class="glass-effect dark:bg-[#0f0f0f]/90 backdrop-blur-3xl rounded-[2rem] shadow-2xl dark:shadow-black/50 border border-white/60 dark:border-white/10 overflow-visible transition-all duration-300 ring-1 ring-black/5 dark:ring-white/5">
                <!-- Input Section -->
                <div class="flex flex-col">
                    ...
                    <textarea
                        ...
                        rows="1"
                        class="w-full px-5 pt-4 pb-1 bg-transparent text-gray-900 dark:text-zinc-100 placeholder-gray-400 dark:placeholder-zinc-600 focus:outline-none resize-none max-h-48 overflow-y-auto text-[15px] font-medium leading-relaxed"
                        :disabled="isLoading"
                    ...
                    <div class="flex items-center justify-between px-4 pb-3 pt-1">
                        ...
                        <button
                            ...
                            class="group flex items-center justify-center w-9 h-9 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl shadow-lg shadow-indigo-500/20 transition-all active:scale-95 disabled:opacity-40 disabled:shadow-none"
                        >
                            <svg v-if="!isLoading" class="w-4.5 h-4.5 transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
